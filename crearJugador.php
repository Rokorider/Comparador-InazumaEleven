...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <script src="scripts/validarDatosJugador.js" defer></script>
    <script src="scripts/estadisticasJugador.js" defer></script>
    <script src="scripts/completarEquipos.js" defer></script>
    <link rel="stylesheet" type="text/css" href="styles/crearJugador.css">
...
<body>
    ...
    <section class="main" id="main">
        ...
        <form class="formulario" id="formDatos" action="usuario/creacionJugador.php" method="post"
